...
async function fn (req) {
  ...
  if (env && (env === 'staging' || env === 'production')) {
    ...
    headers['Content-Security-Policy'] = "default-src 'unsafe-inline' 'self' fonts.googleapis.com fonts.gstatic.com; img-src 'self' data:; script-src www.googletagmanager.com"
